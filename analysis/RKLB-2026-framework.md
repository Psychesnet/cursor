...
### 用 SpaceX（NASDAQ: SPCX）的歷史 PS 重做一張

**結論先講：25–80x 這條帶，對得上 SpaceX「開始被當成成長平台」之後的倍數，但不是全程。** 發射為主的年份比較靠近 **20–32x**；Starlink 成了經常性收入之後，私募 Tender 走到 **25–43x**；2026-06 IPO 與現在的**過去 12 個月 PS 在 87–95x，已經超出 80x**。Forward PS 則掉回約 **24x**（市場用遠年營收把倍數壓下來）。

| 時點 | SpaceX 估值 | 對應營收 | **PS** | 那時的業務 |
| --- | --- | --- | --- | --- |
| 2020 Series J | ~$460 億 | 約 $20 億（估計） | **~23x** | 發射為主，Starlink 還在燒 |
| 2021 融資 | ~$740 億 | ~$23 億 | **~32x** | Starlink 開始放量 |
| 2023-01 最後一次 primary | $1,370 億 | 2022 ~$46 億 | **~30x** | 發射 + Starlink 各半在長 |
| 2023 年底 Tender | $1,800 億 | S-1 2023 **$104 億** | **~17x** | 營收已過 $100 億，倍數先被稀釋 |
| 2024-12 Tender | $3,500 億 | S-1 2024 **$140 億** | **25x** | Connectivity 已過半 |
| 2025-07 Tender | $4,000 億 | 對 2025 $187 億 | **21x** | 同上 |
| 2025-12 Tender | $8,000 億 | 2025 **$187 億** | **43x** | IPO 前最後一輪重估 |
| 2026-06 IPO 目標 | ~$1.75 兆 | 2025 $187 億 | **~94x** | 公開市場用「未來 AI + Starlink」定價 |
| **2026-09-14 現價** | **市值 $2.01 兆** | TTM **$230 億** | **87x** | 公開市場 trailing |
| 同日 Forward PS | $2.01 兆 | 約 $830 億（StockAnalysis） | **24x** | 把 2027 以後的營收折進來 |

資料：[S-1 審計營收 2023–25](https://github.com/shubhamsborkar/spacex-ipo-analysis/blob/main/01_revenue_growth.md)（$10.39B / $14.02B / $18.67B）、[估值時間軸](https://newspaceeconomy.ca/2026/06/05/from-near-bankruptcy-to-1-75-trillion-the-extraordinary-valuation-history-of-spacex/)、[Sacra](https://sacra.com/c/spacex/)、[StockAnalysis SPCX（2026-09-14：$148.15、市值 $2.01T、PS 87.3x、Forward PS 24.1x）](https://stockanalysis.com/stocks/spcx/statistics/)、[Motley Fool：約 87–98x trailing](https://www.fool.com/investing/2026/09/08/should-you-buy-spacex-stock-in-september/)

因此套用時用四檔，對齊 SpaceX 實際走過的點，而不是航太國防的 3–5x：

| 檔位 | 對齊 SpaceX 的哪一段 |
| --- | --- |
| **25x** | 2024-12 Tender（$350B / $140 億）；也接近 Forward 24x |
| **40x** | 2025-12 Tender（$800B / $187 億 ≈ 43x） |
| **60x** | IPO 前私募與公開 trailing 之間的過渡 |
| **80x** | 接近 IPO trailing 下限（目標 ~94x、現在 87x，80x 是「打九折的 SpaceX 公開市場倍數」） |

**套到 RKLB（同一套 $953M / $1.36B / $1.76B、598.46M 股、現價 $62.55）：**

| SpaceX 對齊 PS | **2026E** $953M｜EPS −$0.27 | **2027E** $1.36B｜EPS −$0.07 | **2028E** $1.76B｜EPS +$0.14 | 現價 $62.55 落在哪 |
| --- | --- | --- | --- | --- |
| **25x**（2024 Tender / SPCX forward） | **$40** | **$57** | **$73** | 貴於 2026–27；略低於 2028 |
| **40x**（2025-12 Tender） | **$64** | **$91** | **$118** | **幾乎等於 40x × 2026E（$64）** |
| **60x** | **$96** | **$136** | **$176** | 現價只到 2026 的六成 |
| **80x**（IPO trailing 打九折） | **$127** | **$181** | **$235** | 接近法人目標價 $111–115 的 2026E 80x |

**讀完 SpaceX 之後，RKLB 現價在說什麼：**

現價 $62.55 ≈ **40x × 今年法人營收 $9.53 億**。這不是航太國防的倍數，而是 **SpaceX 2025 年底 IPO 前最後一輪 Tender 的倍數**，提前套在一家營收只有 SpaceX 約 1/24、而且還沒有 Starlink 這種訂閱收入的公司上。

兩件不能直接複製的差異：

1. **SpaceX 的 80x+ 買的是 Connectivity + AI，不是發射。** 2025 年營收 $187 億裡，Connectivity **$114 億（61%）**、Space（發射 / 航天器）只有 **$41 億（22%）**、AI $32 億。公開市場 87x trailing，絕大部分溢價在星座訂閱與 AI，不在 Falcon。RKLB 2026 Q2 仍是 81% Space Systems 硬體 + 19% 發射，**沒有可比較的經常性收入**（Iridium 尚未交割）。
2. **SpaceX 自己的 forward 已經回到 24x。** 現價 $2.01 兆除以約 $830 億遠年營收 = 24x。若 RKLB 也只配 SpaceX 的 *forward* 而不是 *trailing*，對得上的是上表 **25x 那一列**（2028E 隱含 $73），不是 80x。

所以：25–80x 可以當「市場曾經願意為 Space 成長股付的帶」；套用後，RKLB 現價已經站在這條帶的 **中低段（40x 今年營收）**。要合理化 80x，等於要求市場把 RKLB 當成 IPO 當下的 SPCX——那是 Starlink 千萬用戶 + AI 敘事的倍數，不是 Neutron 還沒首飛的發射 / 造星公司的倍數。
...
| **15–25x（樂觀）** | 品類贏家、超高增長，利潤可以「以後再驗證」 | SpaceX 2024-12 Tender **25x**；SPCX 現在 Forward PS **24x** | 對齊「SpaceX 的遠年倍數」，不是它的 trailing。RKLB 現價對 2028E 已是 21x |
| **40x** | IPO 前成長平台重估 | SpaceX 2025-12 Tender **43x** | **RKLB 現價 ≈ 40x 2026E**，已經在用這檔 |
| **60–80x** | 公開市場把多年後的訂閱 / 平台收入提前付清 | SPCX IPO trailing **~94x**、現在 TTM **87x** | 套在 RKLB 2026E 會得到 $96–$127，接近法人目標價；前提是把 Starlink/AI 的倍數借來用 |
| **30x+ / 87x TTM（SPCX 現價）** | trailing 極貴、forward 被遠年營收救回來 | SPCX 自己也是虧損（TTM 淨損 $89 億） | 不能拿 SPCX 的 87x trailing 當 RKLB 的「合理」；連 SpaceX 都要靠 Forward 24x 才能看起來不瘋 |
